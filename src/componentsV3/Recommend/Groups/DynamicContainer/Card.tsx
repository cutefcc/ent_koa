...
@connect((state) => ({
  ...
  dynamicDetaillLoading: state.loading.effects['groups/fetchDynamicDetails'],
}))
export default class Card extends React.Component<Props, State> {
  ...
  handleTrackTalentDynamicProfileEvent = () => {
    ...
    const u2 = talent.id
    if (window.voyager) {
      console.log('dynamicCategoryMap', dynamicCategoryMap)
      console.log('currentDynamicCategory', currentDynamicCategory)
