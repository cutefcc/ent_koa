...
@connect((state) => ({
  ...
  data: state.subscribe.dynamic,
  pagination: state.subscribe.paginationParam,
  sid: state.subscribe.sid,
...
> {
  ...
  renderCard = (talent, pageIndex, mosaic = false) => {
    ...
    const param = {
      ...
      fr: getFr(currentTab),
      subid: R.pathOr('', ['props', 'currCondition', 'id'], this),
    }
    return (
      <Card
        data={talent}
