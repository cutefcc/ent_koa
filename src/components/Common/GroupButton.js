  ...
  render() {
    const button = (
      <Button
        ...
        className={`${styles.operation}  ${styles.group} ${this.props.className}`}
      >
        {this.props.iconType ? (
          <Icon
    ...
    return (
      <div>
        {this.props.buttonText === '' && !this.props.disabled ? (
          <Popover placement="topLeft" content="添加到人才银行" trigger="hover">
            {button}
          </Popover>
        ) : (
          button
        ...
        {this.state.showGroupModal && (
          ...
          >
            <div style={{ maxHeight: '400px', overflow: 'auto' }}>
              ...
              >
                <h4 className="font-size-24 color-common">
                  请选择企业人才分组
                </h4>
