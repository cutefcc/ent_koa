...
import { Modal, Typography, Button, Message } from 'mm-ent-ui'
import * as R from 'ramda'
import * as styles from './editCompanyFocused_v2.less'
...
@connect((state) => ({
  groupList: state.talentDiscover.companyGroups,
...
> {
  ...
  handleAddGroup = () => {
    ...
    this.props
      .dispatch({
        type: 'talentDiscover/addCompanyGroup',
        payload: {
          name: company.name,
          cid: company.cid,
        },
